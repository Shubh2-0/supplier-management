    ...
    public OpenAPI supplierManagementOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST endpoints for the Supplier Management module — backed by PostgreSQL with Kafka event publishing.")
                        .version("1.0.0")
                        .contact(new Contact().name("BrightCore Coding Challenge"))
